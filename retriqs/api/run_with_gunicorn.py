...
from retriqs.api.utils_api import display_splash_screen, check_env_file
from retriqs.api.config import global_args
...
def main():
    ...
    if (
        ...
        print("     retriqs-gunicorn --workers 2")
        ...
        print("     retriqs-server --workers 1")
        print("=" * 80 + "\n")
        sys.exit(1)
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from retriqs.api import gunicorn_config
        ...
        def load(self):
            ...
            from retriqs.api.retriqs_server import get_application
