...
from retriqs.utils import setup_logger, get_env_value
from retriqs.constants import (
    DEFAULT_LOG_MAX_BYTES,
    DEFAULT_LOG_BACKUP_COUNT,
    DEFAULT_LOG_FILENAME,
)
from retriqs.api.storage_paths import resolve_log_file_path


# Resolve runtime log path (uses %LOCALAPPDATA% in frozen Windows runtime)
...
errorlog = os.getenv("ERROR_LOG", log_file_path)  # Default write to retriqs.log
accesslog = os.getenv("ACCESS_LOG", log_file_path)  # Default write to retriqs.log
