...
import asyncio
from retriqs import LightRAG, QueryParam
from retriqs.utils import TiktokenTokenizer
...
class OllamaAPI:
    def __init__(self, rag: LightRAG, ollama_server_infos=None, top_k: int = 60, api_key: Optional[str] = None):
        self.rag = rag
