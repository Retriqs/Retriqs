...
Usage:
    python -m retriqs.tools.clean_llm_query_cache
    # or
...
from retriqs.kg import STORAGE_ENV_REQUIREMENTS
from retriqs.kg.shared_storage import set_all_update_flags
from retriqs.namespace import NameSpace
from retriqs.utils import setup_logger
...
class CleanupTool:
    ...
    def get_storage_class(self, storage_name: str):
        ...
        if storage_name == "JsonKVStorage":
            ...
            from retriqs.kg.redis_impl import RedisKVStorage

            return RedisKVStorage
        elif storage_name == "PGKVStorage":
            from retriqs.kg.postgres_impl import PGKVStorage

            return PGKVStorage
        elif storage_name == "MongoKVStorage":
            from retriqs.kg.mongo_impl import MongoKVStorage
    ...
    async def count_query_caches_pg(self, storage) -> Dict[str, Dict[str, int]]:
        ...
        Returns:
            Dictionary with counts for each mode and cache_type
        """
        from retriqs.kg.postgres_impl import namespace_to_table_name
    ...
    async def run(self):
        ...
        try:
            ...
            from retriqs.kg.shared_storage import initialize_share_data
            ...
            try:
                from retriqs.kg.shared_storage import finalize_share_data
