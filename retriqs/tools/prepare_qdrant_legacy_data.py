...
Usage:
    python -m retriqs.tools.prepare_qdrant_legacy_data
    # or
    python lightrag/tools/prepare_qdrant_legacy_data.py

    # Specify custom workspace
    python -m retriqs.tools.prepare_qdrant_legacy_data --workspace space1

    # Process specific collection types only
    python -m retriqs.tools.prepare_qdrant_legacy_data --types chunks,entities

    # Dry run (preview only, no actual changes)
    python -m retriqs.tools.prepare_qdrant_legacy_data --dry-run
"""
