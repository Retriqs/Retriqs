...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="retriqs-download-cache",
        description="Download cache files for LightRAG offline deployment",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Download to default location (~/.tiktoken_cache)
  retriqs-download-cache

  # Download to specific directory
  retriqs-download-cache --cache-dir ./offline_cache/tiktoken

  # Download specific models only
  retriqs-download-cache --models gpt-4o-mini gpt-4
