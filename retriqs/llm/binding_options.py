...
from retriqs.constants import DEFAULT_TEMPERATURE
    ...
    def generate_dot_env_sample(cls):
        ...
        sample_top = (
            ...
            + (
                ...
                "#\n"
                "# To generate run:\n"
                "# $ python -m retriqs.llm.binding_options\n"
            )
            + "#" * 80
            + "\n"
        )
...
#
# Usage:
#   python -m retriqs.llm.binding_options           # Generate .env sample
#   python -m retriqs.llm.binding_options test      # Test argument parsing
#
# =============================================================================
