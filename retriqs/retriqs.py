...
from retriqs.prompt import PROMPTS
from retriqs.exceptions import PipelineCancelledException
...
from retriqs.constants import GRAPH_FIELD_SEP
...
from retriqs.types import KnowledgeGraph
...
class LightRAG:
    ...
    """Neo4J database URI. If None, will fall back to environment variables or defaults."""

    neo4j_username: str | None = field(default=None)
    """Neo4J database username. If None, will fall back to environment variables or defaults."""

    neo4j_password: str | None = field(default=None)
    """Neo4J database password. If None, will fall back to environment variables or defaults."""
    ...
    async def initialize_storages(self):
        ...
        if self._storages_status == StoragesStatus.CREATED:
            ...
            from retriqs.kg.shared_storage import initialize_pipeline_status
    ...
    def _get_storage_class(self, storage_name: str) -> Callable[..., Any]:
        ...
        if storage_name == "JsonKVStorage":
            from retriqs.kg.json_kv_impl import JsonKVStorage

            return JsonKVStorage
        elif storage_name == "NanoVectorDBStorage":
            from retriqs.kg.nano_vector_db_impl import NanoVectorDBStorage

            return NanoVectorDBStorage
        elif storage_name == "NetworkXStorage":
            from retriqs.kg.networkx_impl import NetworkXStorage

            return NetworkXStorage
        elif storage_name == "JsonDocStatusStorage":
            from retriqs.kg.json_doc_status_impl import JsonDocStatusStorage
    ...
    async def adelete_by_entity(self, entity_name: str) -> DeletionResult:
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from retriqs.utils_graph import adelete_by_entity
    ...
    async def adelete_by_relation(
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from retriqs.utils_graph import adelete_by_relation
    ...
    async def get_entity_info(
        ...
        from retriqs.utils_graph import get_entity_info
    ...
    async def get_relation_info(
        ...
        from retriqs.utils_graph import get_relation_info
    ...
    async def aedit_entity(
        ...
        """
        from retriqs.utils_graph import aedit_entity
    ...
    async def aedit_relation(
        ...
        """
        from retriqs.utils_graph import aedit_relation
    ...
    async def acreate_entity(
        ...
        """
        from retriqs.utils_graph import acreate_entity
    ...
    async def acreate_relation(
        ...
        """
        from retriqs.utils_graph import acreate_relation
    ...
    async def amerge_entities(
        ...
        """
        from retriqs.utils_graph import amerge_entities
    ...
    async def aexport_data(
        ...
        """
        from retriqs.utils import aexport_data as utils_aexport_data
