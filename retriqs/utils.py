...
if TYPE_CHECKING:
    from retriqs.base import BaseKVStorage, BaseVectorStorage, QueryParam
...
def setup_logger(
    ...
    Args:
        ...
        log_file_path: Path to the log file. If None and file logging is enabled, defaults to retriqs.log in LOG_DIR or cwd
