...
import useRetriqsGraph from '@/hooks/useRetriqsGraph'
...
const PropertiesView = () => {
  const { getNode, getEdge } = useRetriqsGraph()
  ...
  return (
    <div className="bg-card/90 max-w-sm rounded-2xl border border-border/40 p-4 text-xs backdrop-blur-xl shadow-2xl">
      {currentType == 'node' ? (
